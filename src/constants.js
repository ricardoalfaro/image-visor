...
export const COLLECTIONS_DB_NAME = "imageVisorCollections";
export const COLLECTIONS_DB_STORE = "collections";
export const COLLECTIONS_FOLDER_PREFIX = "__image_visor_collection__:";
export const RECENT_FOLDERS_LIMIT = 50;
